...
const Posts = () => {
  ...
  function handleScroll() {
    ...
    if (scrolled + deviceHeight >= containerY + height - deviceHeight * 0.02)
      setPostsGroup((value) => value + 1);
  }
      ...
      <div className="flex-col lg:flex-row items-center lg:items-stretch flex gap-3">
        <div className="w-full lg:min-w-0 lg:w-2/5">
          <div className="bg-blackish rounded-lg py-1.5 px-3 text-white sticky top-10">
            ...
            <div
              className="text-sm text-gray-200 text-center py-2.5"
            ...
            <ul className="text-xs text-gray-300 bio-intro font-bold">
              <li>
                ...
                <span>
                  Studied at{" "}
                  <span className="text-white">Mamatid Senior High School</span>
                </span>
              </li>
              <li>
                <FBIcons icon="school" />
            ...
            <div className="text-xs font-bold flex gap-2 flex-wrap">
              {[
                ...
                return (
                  <button
                    key={index}
                    className="flex items-center py-1.5 px-3.5 gap-1 rounded-full"
        ...
        <div
          ref={postsContainer}
          className="lg:w-3/5 w-full lg:min-w-0 flex flex-col gap-3"
        >
          <div className="bg-blackish rounded py-1.5 px-3 flex justify-between text-white items-center">
            ...
            <button className="flex items-center text-xs font-bold gap-1.5 bg-grayish px-2.5 py-1.5 rounded">
              <i
                className="icon-filter mt-1"
                style={{
                  backgroundImage:
                    "url(https://static.xx.fbcdn.net/rsrc.php/v3/yY/r/Bf445eaOe1F.png)",
